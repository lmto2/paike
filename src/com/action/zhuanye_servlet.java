...
public class zhuanye_servlet extends HttpServlet
{
	...
	public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException, IOException 
	{
		...
		if(actiontype.endsWith("zhuanyeMana"))
		{
			zhuanyeMana(req, res);
		}
		if(actiontype.endsWith("zhuanyeAdd"))
		{
			zhuanyeAdd(req, res);
		}
		if(actiontype.endsWith("zhuanyeDel"))
		{
			zhuanyeDel(req, res);
		}
		if(actiontype.endsWith("zhuanyeEdit"))
		{
			zhuanyeEdit(req, res);
		}
	}
	...
	{
		List<Tzhuanye> zhuanyeList=new ArrayList<Tzhuanye>();
