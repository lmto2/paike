...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           var s=0;
           function xuankeAdd(stu_id,kecheng_id)
           {
               s=kecheng_id;
               document.getElementById("indicator"+s).style.display="block";
               loginService.xuankeAdd(stu_id,kecheng_id,callback);
           }
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<a style="color: red" href="#" onclick="xuankeAdd(${requestScope.stu_id },${kecheng.id})" class="pn-loperator">添加</a>
